        ...
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <div class="d-flex gap-2">
                    @can('export.crm')<a class="btn btn-outline-primary" href="{{ route('import-export.export', 'contacts') }}{{ request()->getQueryString() ? '?' . request()->getQueryString() : '' }}">Export CSV</a>@endcan
                    @can('contacts.create')<a class="btn btn-primary" href="{{ route('contacts.create') }}">Create Contact</a>@endcan
                </div>
            </div>
